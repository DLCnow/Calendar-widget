...
var _MonthChanger = __webpack_require__(33);

var _MonthChanger2 = _interopRequireDefault(_MonthChanger);

var _DecadeView = __webpack_require__(34);

var _DecadeView2 = _interopRequireDefault(_DecadeView);

var _DecadeChanger = __webpack_require__(35);

var _DecadeChanger2 = _interopRequireDefault(_DecadeChanger);

var _YearView = __webpack_require__(36);

var _YearView2 = _interopRequireDefault(_YearView);

var _YearChanger = __webpack_require__(37);

var _YearChanger2 = _interopRequireDefault(_YearChanger);
...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        key: 'setChanger',
        value: function setChanger() {
            if (this.state.view == "month") {
                return _react2.default.createElement(_MonthChanger2.default, {
                ...
                return _react2.default.createElement(_DecadeChanger2.default, {
                    year: this.state.year,
                    month: this.state.month,
                    setYear: this.setYear.bind(this),
                    changeView: this.changeView.bind(this) });
            } else if (this.state.view == "year") {
                return _react2.default.createElement(_YearChanger2.default, {
                    year: this.state.year,
                    month: this.state.month,
                    setYear: this.setYear.bind(this),
                    changeView: this.changeView.bind(this) });
        ...
        value: function setView() {
            if (this.state.view == "month") {
                return _react2.default.createElement(_Monthview2.default, { year: this.state.year, month: this.state.month });
            } else if (this.state.view == "decade") {
...
var MonthChanger = function (_Component) {
    _inherits(MonthChanger, _Component);

    function MonthChanger(_ref) {
        var year = _ref.year,
            month = _ref.month,
        ...
        _classCallCheck(this, MonthChanger);

        return _possibleConstructorReturn(this, (MonthChanger.__proto__ || Object.getPrototypeOf(MonthChanger)).call(this));
    }

    _createClass(MonthChanger, [{
        key: "goPrevMonth",
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        {
                            onClick: function onClick() {
                                _this2.props.changeView("decade");
                            } },
                        this.props.year
                    ),
                    "\u5E74",
...
var DecadeView = function (_Component) {
    ...
    function DecadeView(_ref) {
        ...
        return _possibleConstructorReturn(this, (DecadeView.__proto__ || Object.getPrototypeOf(DecadeView)).call(this));
    }
    ...
    _createClass(DecadeView, [{
        ...
        value: function showTable() {
            ...
            var firstYear = this.props.year - this.props.year % 10 - 10;
            var domArr = [];
            for (var i = 0; i < 10; i++) {
                var temp = [];

                var _loop = function _loop() {
                    var year = _this2.props.year;
                    var y = firstYear + j * 10 + i;
                    temp.push(_react2.default.createElement(
                        'td',
                        {
                            className: (0, _classnames2.default)({
                            ...
                            key: y,
                            onClick: function onClick() {
                                _this2.props.changeView("month"), _this2.props.setYear(y);
                            } },
                        y
                    ));
                };
...
var DecadeChanger = function (_Component) {
    _inherits(DecadeChanger, _Component);

    function DecadeChanger(_ref) {
        var year = _ref.year,
            setYear = _ref.setYear,
            changeView = _ref.changeView;

        _classCallCheck(this, DecadeChanger);

        return _possibleConstructorReturn(this, (DecadeChanger.__proto__ || Object.getPrototypeOf(DecadeChanger)).call(this));
    }

    _createClass(DecadeChanger, [{
        key: "goPrevTenYear",
        value: function goPrevTenYear() {
            this.props.setYear(this.props.year - 10);
        }
    }, {
        key: "goNextTenYear",
        value: function goNextTenYear() {
            this.props.setYear(this.props.year + 10);
        }
    }, {
        key: "render",
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                { className: "decadechanger" },
                _react2.default.createElement(
                    "button",
                    { onClick: function onClick() {
                            _this2.goPrevTenYear();
                        } },
                    "<"
                ),
                _react2.default.createElement(
...
var YearView = function (_Component) {
    ...
    function YearView(setMonth, changeView) {
    ...
    _createClass(YearView, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                { className: "yearviewwrap", ref: "yearviewwrap" },
                _react2.default.createElement(
                    "table",
                    null,
                    _react2.default.createElement(
...
var YearChanger = function (_Component) {
    _inherits(YearChanger, _Component);

    function YearChanger(_ref) {
        var year = _ref.year,
            changView = _ref.changView,
            setYear = _ref.setYear;

        _classCallCheck(this, YearChanger);

        return _possibleConstructorReturn(this, (YearChanger.__proto__ || Object.getPrototypeOf(YearChanger)).call(this));
    }

    _createClass(YearChanger, [{
        key: "goPrevYear",
